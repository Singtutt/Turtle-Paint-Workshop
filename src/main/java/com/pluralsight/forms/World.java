 ...
 * Usage example:
 * <pre>
 * forms.World basic = new forms.World();
 * forms.World fancy = new forms.World(640, 480, Color.YELLOW);
 *
 * forms.Turtle t1 = new forms.Turtle(basic);
 * forms.Turtle t2 = new forms.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    public World(int width, int height, Color backgroundColor) {
        super("forms.Turtle forms.World");
